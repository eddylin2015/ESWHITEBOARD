...
(function() {
  ...
  */
  App.init = function() {
	...
	App.socket.on('penOpenClose', function(data) {
      return App.penOpenClose(data.x, data.y, data.type);
    });	
	App.penOpenClose = function(x, y, type,pencolor) {
      penOpen= x;
    };
	...
	App.drawbg = function(x, y, type) {
		...
		//ctx.drawImage(img,10,10,50,277);
      };
